...
let str = `
*ミ 𝙷𝙾𝙻𝙰 ✨${name}✨, 𝙰𝚀𝚄𝙸 𝙴𝚂𝚃𝙰 𝙴𝙻 𝙼𝙴𝙽𝚄 𝙲𝙾𝙼𝙿𝙻𝙴𝚃𝙾 𝙳𝙴 JCystem - 𝙱𝙾𝚃 🔱彡*
...
° ඬ⃟🎖️ _${usedPrefix}ppt *<papel / tijera /p
...
`.trim()
conn.sendHydrated2(m.chat, str, wm, pp, 'https://www.paypal.me/srnovus', '𝙿𝙰𝚈𝙿𝙰𝙻', 'https://github.com/jcystem/', '𝙶𝙸𝚃𝙷𝚄𝙱', [
['📮 𝙳𝙾𝙽𝙰𝚁 📮', '/donasi'],
['🌹 𝙾𝚆𝙽𝙴𝚁 🌹', '/owner'],
['🐾 𝙸𝙽𝙵𝙾𝙱𝙾𝚃 🐾', '/infobot']
], m,)
